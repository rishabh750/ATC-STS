...
class gui:
	...
	def predictor(self,plane):
		...
		#present heading
		pygame.draw.line(self.screen,(0,100,0),(lon,lat),(lon-self.zoom*numpy.sin(-1*head*pi/180),lat-self.zoom*numpy.cos(-1*head*pi/180)),1)
		#expected heading
		if plane.state == 'inbound':
			pygame.draw.line(self.screen,(0,0,100),(lon,lat),(lon-self.zoom*numpy.sin(-1*head*pi/180),lat-self.zoom*numpy.cos(-1*head*pi/180)),1)
